...
export const Expensess = <i className="fa-solid fa-money-bill-transfer"></i>
...
export const expenseTitle = <i className="fa-solid fa-money-bill-wave"></i>
...
export const Balance = <i class="fa-solid fa-wallet"></i>